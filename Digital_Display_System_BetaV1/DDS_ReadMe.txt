【Digital Display System Betatest Version 1.1】
...
　またセットアップ時に未知のエラーが発生し復旧不可能になる場合もあるので、
　使用する際は必ずバックアップを作成するなどのフェイルセーフを徹底してください。
...
1.セットアップ済みのアバターに着替えて、EXMenuからOSCを有効化しておきます。

2.VRChatが起動しているPCでDDS_OSC_Clock.exeを実行します。

3.OSC送信が開始され、アバターのディスプレイ部分に現在時刻が表示されます。

4.終了時はCtrl+Cを押下すると終了します。
...
-テクスチャを整理し、PhotoshopやClipStudioなどで好きなフォントへ変更可能にする
